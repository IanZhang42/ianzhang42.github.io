...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item \textbf{Coursework:} Data Analysis, Probability, Machine learning, Mathematical Statistics, Time Series Analysis, Stochastic Processes, Calculus, Linear Algebra
            \end{highlights}
        \end{onecolentry}
